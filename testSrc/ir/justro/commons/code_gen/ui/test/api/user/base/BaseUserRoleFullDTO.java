...
import ir.justro.commons.code_gen.ui.test.api.user.dto.UserRoleFullDTO;
...
public abstract class BaseUserRoleFullDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<UserRole> {
	...
	private ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> features;
	 ...
	 */
	@JsonProperty
	public ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> getFeatures() {
	 ...
	 */
	public void setFeatures(ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> features) {
	 ...
	 */
	protected ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> load_Features(UserRole userRole) {
		ir.viratech.commons.util.relation_map.RelationMap<Feature> __internalProperty_featuresRelationMap = userRole.getFeaturesRelationMap();
		if (__internalProperty_featuresRelationMap == null)
			return null; 
		ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> features = new ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature>();
	 ...
	 */
	protected void save_Features(UserRole userRole, ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<Feature> featuresDto)
			throws ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException {
		if (featuresDto == null) {
