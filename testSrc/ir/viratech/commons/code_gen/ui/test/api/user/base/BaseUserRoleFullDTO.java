...
import ir.viratech.commons.code_gen.ui.test.api.user.dto.UserRoleFullDTO;
...
public abstract class BaseUserRoleFullDTO extends ir.viratech.commons.api.dto.AbstractFullDTO<UserRole> {
	...
	public static abstract class BaseFieldInfoContext extends ir.viratech.commons.api.search.field.AbstractFieldInfoContext<UserRoleFullDTO> {
		...
		protected BaseFieldInfoContext() {
			...
			//Disabled fieldInfo for property: features
		}
	...
	private boolean __modified__Description = false;
	...
	public void setDescription(String description) {
		this.__modified__Description = true;
		this.description = description;
	}
	
	/**
	 * Shows the modification state of the property "description".
	 * 
	 * @return true if the property is modified
	 */
	public boolean hasModifiedDescription() {
		return this.__modified__Description;
	}
	
	
	// features
	
	private ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> features;
	private boolean __modified__Features = false;
	 ...
	 */
	@JsonProperty
	public ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> getFeatures() {
	 ...
	 */
	public void setFeatures(ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> features) {
		this.__modified__Features = true;
		this.features = features;
	}
	
	/**
	 * Shows the modification state of the property "features".
	 * 
	 * @return true if the property is modified
	 */
	public boolean hasModifiedFeatures() {
		return this.__modified__Features;
	}
	 ...
	 */
	protected ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> load_Features(UserRole userRole) {
		ir.viratech.commons.util.relation_map.RelationMap<ir.viratech.commons.code_gen.ui.test.model.user.Feature> __internalProperty_featuresRelationMap = userRole.getFeaturesRelationMap();
		if (__internalProperty_featuresRelationMap == null)
			return null; 
		ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> features = new ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature>();
	 ...
	 */
	protected void save_Features(UserRole userRole, ir.viratech.commons.api.dto.relation_map.DisplableRelationMapDTO<ir.viratech.commons.code_gen.ui.test.model.user.Feature> featuresDto)
			throws ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException {
		if (featuresDto == null) {
			throw new ir.viratech.commons.api.entity_modifier.BadDtoEntityModificationException("The given dto must not be null.");
		} else {
			featuresDto.saveTo(userRole.getFeaturesRelationMap());
		}
	}
